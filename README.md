...
Segmenting and detecting objects in the foreground with the [RAS-Architecture](http://openaccess.thecvf.com/content_ECCV_2018/html/Shuhan_Chen_Reverse_Attention_for_ECCV_2018_paper.html).
